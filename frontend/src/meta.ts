        ...
        case 'Proposal':
            return [
                ...
                { name: 'Type', value: meta.proposalType || 'undefined' },
                {
                    ...
                    value: meta.pi?.lastname || 'undefined',
                    data: meta.pi,
                },
                {
                    name: 'Leader',
                    value: meta.leader?.lastname || 'undefined',
                    data: meta.leader,
                },
                {
                    name: 'Applicant',
                    value: meta.applicant?.lastname || 'undefined',
                    data: meta.applicant,
                },
            ];
        case 'Analysis':
            return [
                ...
                {
                    name: 'Online',
                    value: meta.onlineAnalysis ? 'Requested' : 'Not requested',
                    data: meta.onlineAnalysis,
                },
            ];
    }
    return [];
...
export function TableDataFromCollection(meta: CollectionEntry, section: string): TableData {
    return [
        ...
        {
            name: 'Facility',
            value: meta.parentBeamtimeMeta!.facility || 'undefined',
        },
        {
            name: 'Beamline',
            value: meta.parentBeamtimeMeta!.beamline || 'undefined',
        },
        {
            name: 'Start',
            value: meta.eventStart ? meta.eventStart.toString() : '',
        },
        { name: 'End', value: IsoDateToStr(meta.eventEnd) },
    ];
}
